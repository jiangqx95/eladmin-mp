/*
 ...
 Source Server         : mysql_8.0.27-3306
...
CREATE TABLE `code_column_config`  (
  `column_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'ID',
  `table_name` varchar(180) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '表名',
  `column_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '数据库字段名称',
  `column_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '数据库字段类型',
  `dict_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '字典名称',
  `extra` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '字段额外的参数',
  ...
  `key_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '数据库字段键类型',
  `list_show` bit(1) NULL DEFAULT NULL COMMENT '是否在列表显示',
  `not_null` bit(1) NULL DEFAULT NULL COMMENT '是否必填',
  `query_type` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '查询 1:模糊 2：精确',
...
CREATE TABLE `code_gen_config`  (
  `config_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'ID',
...
CREATE TABLE `mnt_app`  (
  `app_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'ID',
...
CREATE TABLE `mnt_deploy`  (
  `deploy_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'ID',
  `app_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '应用编号',
  `create_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建者',
  `update_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '更新者',
...
CREATE TABLE `mnt_deploy_history`  (
  ...
  `deploy_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '部署编号',
...
CREATE TABLE `mnt_deploy_server`  (
  `deploy_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '部署ID',
  `server_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '服务ID',
...
CREATE TABLE `mnt_server`  (
  `server_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'ID',
...
CREATE TABLE `sys_dept`  (
  `dept_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'ID',
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '名称',
  `full_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '名称全称',
...
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES ('15', '8', 0, 'UI部门', 'UI部门', NULL, NULL, 7, b'1', 'admin', 'admin', '2020-05-13 22:56:53', '2020-05-14 12:54:13');
INSERT INTO `sys_dept` VALUES ('17', '2', 0, '研发一组', '研发一组', NULL, NULL, 999, b'1', 'admin', 'admin', '2020-08-02 14:49:07', '2020-08-02 14:49:07');
INSERT INTO `sys_dept` VALUES ('2', '7', 1, '研发部', '研发部', NULL, NULL, 3, b'1', 'admin', 'admin', '2019-03-25 09:15:32', '2020-08-02 14:48:47');
INSERT INTO `sys_dept` VALUES ('5', '7', 0, '运维部', '运维部', NULL, NULL, 4, b'1', 'admin', 'admin', '2019-03-25 09:20:44', '2020-05-17 14:27:27');
INSERT INTO `sys_dept` VALUES ('6', '8', 0, '测试部', '测试部', NULL, NULL, 6, b'1', 'admin', 'admin', '2019-03-25 09:52:18', '2020-06-08 11:59:21');
INSERT INTO `sys_dept` VALUES ('7', NULL, 2, '华南分部', '华南分部', NULL, NULL, 0, b'1', 'admin', 'admin', '2019-03-25 11:04:50', '2020-06-08 12:08:56');
INSERT INTO `sys_dept` VALUES ('8', NULL, 2, '华北分部', '华北分部', NULL, NULL, 1, b'1', 'admin', 'admin', '2019-03-25 11:04:53', '2020-05-14 12:54:00');
...
CREATE TABLE `sys_dict`  (
  `dict_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'ID',
...
-- Records of sys_dict
-- ----------------------------
INSERT INTO `sys_dict` VALUES ('1', 'user_status', '用户状态', 'admin', 'admin', '2019-10-27 20:31:36', NULL);
INSERT INTO `sys_dict` VALUES ('4', 'dept_status', '部门状态', 'admin', 'admin', '2019-10-27 20:31:36', NULL);
INSERT INTO `sys_dict` VALUES ('5', 'job_status', '岗位状态', 'admin', 'admin', '2019-10-27 20:31:36', NULL);
...
CREATE TABLE `sys_job`  (
  `job_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'ID',
...
-- Records of sys_job
-- ----------------------------
INSERT INTO `sys_job` VALUES ('10', '产品经理', b'1', 4, 'admin', NULL, '2019-03-29 14:55:51', NULL);
INSERT INTO `sys_job` VALUES ('11', '全栈开发', b'1', 2, 'admin', 'admin', '2019-03-31 13:39:30', '2020-05-05 11:33:43');
INSERT INTO `sys_job` VALUES ('12', '软件测试', b'1', 5, 'admin', 'admin', '2019-03-31 13:39:43', '2020-05-10 19:56:26');
INSERT INTO `sys_job` VALUES ('8', '人事专员', b'1', 3, 'admin', NULL, '2019-03-29 14:52:28', NULL);
...
CREATE TABLE `sys_log`  (
  ...
  `username` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '操作用户',
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '地址',
  `browser` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '浏览器',
  `exception_detail` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '异常详细',
  `create_time` datetime NOT NULL COMMENT '创建日期',
...
CREATE TABLE `sys_menu`  (
  `menu_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'ID',
  `pid` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '上级菜单ID',
  `sub_count` int NOT NULL DEFAULT 0 COMMENT '子菜单数目',
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES ('1', NULL, 7, 0, '系统管理', NULL, NULL, 1, 'system', 'system', b'0', b'0', b'0', NULL, 'admin', NULL, '2018-12-18 15:11:29', NULL);
INSERT INTO `sys_menu` VALUES ('10', NULL, 5, 0, '组件管理', NULL, NULL, 50, 'zujian', 'components', b'0', b'0', b'0', NULL, 'admin', NULL, '2018-12-19 13:38:16', NULL);
INSERT INTO `sys_menu` VALUES ('102', '97', 0, 2, '删除', NULL, '', 999, '', '', b'0', b'0', b'0', 'deployHistory:del', 'admin', NULL, '2019-11-17 09:32:48', NULL);
INSERT INTO `sys_menu` VALUES ('103', '92', 0, 2, '服务器新增', NULL, '', 999, '', '', b'0', b'0', b'0', 'serverDeploy:add', 'admin', NULL, '2019-11-17 11:08:33', NULL);
INSERT INTO `sys_menu` VALUES ('104', '92', 0, 2, '服务器编辑', NULL, '', 999, '', '', b'0', b'0', b'0', 'serverDeploy:edit', 'admin', NULL, '2019-11-17 11:08:57', NULL);
INSERT INTO `sys_menu` VALUES ('105', '92', 0, 2, '服务器删除', NULL, '', 999, '', '', b'0', b'0', b'0', 'serverDeploy:del', 'admin', NULL, '2019-11-17 11:09:15', NULL);
INSERT INTO `sys_menu` VALUES ('106', '93', 0, 2, '应用新增', NULL, '', 999, '', '', b'0', b'0', b'0', 'app:add', 'admin', NULL, '2019-11-17 11:10:03', NULL);
INSERT INTO `sys_menu` VALUES ('107', '93', 0, 2, '应用编辑', NULL, '', 999, '', '', b'0', b'0', b'0', 'app:edit', 'admin', NULL, '2019-11-17 11:10:28', NULL);
INSERT INTO `sys_menu` VALUES ('108', '93', 0, 2, '应用删除', NULL, '', 999, '', '', b'0', b'0', b'0', 'app:del', 'admin', NULL, '2019-11-17 11:10:55', NULL);
INSERT INTO `sys_menu` VALUES ('109', '94', 0, 2, '部署新增', NULL, '', 999, '', '', b'0', b'0', b'0', 'deploy:add', 'admin', NULL, '2019-11-17 11:11:22', NULL);
INSERT INTO `sys_menu` VALUES ('11', '10', 0, 1, '图标库', 'Icons', 'components/icons/index', 51, 'icon', 'icon', b'0', b'0', b'0', NULL, 'admin', NULL, '2018-12-19 13:38:49', NULL);
INSERT INTO `sys_menu` VALUES ('110', '94', 0, 2, '部署编辑', NULL, '', 999, '', '', b'0', b'0', b'0', 'deploy:edit', 'admin', NULL, '2019-11-17 11:11:41', NULL);
INSERT INTO `sys_menu` VALUES ('111', '94', 0, 2, '部署删除', NULL, '', 999, '', '', b'0', b'0', b'0', 'deploy:del', 'admin', NULL, '2019-11-17 11:12:01', NULL);
INSERT INTO `sys_menu` VALUES ('112', '98', 0, 2, '数据库新增', NULL, '', 999, '', '', b'0', b'0', b'0', 'database:add', 'admin', NULL, '2019-11-17 11:12:43', NULL);
INSERT INTO `sys_menu` VALUES ('113', '98', 0, 2, '数据库编辑', NULL, '', 999, '', '', b'0', b'0', b'0', 'database:edit', 'admin', NULL, '2019-11-17 11:12:58', NULL);
INSERT INTO `sys_menu` VALUES ('114', '98', 0, 2, '数据库删除', NULL, '', 999, '', '', b'0', b'0', b'0', 'database:del', 'admin', NULL, '2019-11-17 11:13:14', NULL);
INSERT INTO `sys_menu` VALUES ('116', '36', 0, 1, '生成预览', 'Preview', 'generator/preview', 999, 'java', 'generator/preview/:tableName', b'0', b'1', b'1', NULL, 'admin', NULL, '2019-11-26 14:54:36', NULL);
INSERT INTO `sys_menu` VALUES ('14', '36', 0, 1, '邮件工具', 'Email', 'tools/email/index', 35, 'email', 'email', b'0', b'0', b'0', NULL, 'admin', NULL, '2018-12-27 10:13:09', NULL);
INSERT INTO `sys_menu` VALUES ('15', '10', 0, 1, '富文本', 'Editor', 'components/Editor', 52, 'fwb', 'tinymce', b'0', b'0', b'0', NULL, 'admin', NULL, '2018-12-27 11:58:25', NULL);
INSERT INTO `sys_menu` VALUES ('18', '36', 3, 1, '存储管理', 'Storage', 'tools/storage/index', 34, 'qiniu', 'storage', b'0', b'0', b'0', 'storage:list', 'admin', NULL, '2018-12-31 11:12:15', NULL);
INSERT INTO `sys_menu` VALUES ('19', '36', 0, 1, '支付宝工具', 'AliPay', 'tools/aliPay/index', 37, 'alipay', 'aliPay', b'0', b'0', b'0', NULL, 'admin', NULL, '2018-12-31 14:52:38', NULL);
INSERT INTO `sys_menu` VALUES ('2', '1', 3, 1, '用户管理', 'User', 'system/user/index', 2, 'peoples', 'user', b'0', b'0', b'0', 'user:list', 'admin', NULL, '2018-12-18 15:14:44', NULL);
INSERT INTO `sys_menu` VALUES ('21', NULL, 2, 0, '多级菜单', NULL, '', 900, 'menu', 'nested', b'0', b'0', b'0', NULL, 'admin', 'admin', '2019-01-04 16:22:03', '2020-06-21 17:27:35');
INSERT INTO `sys_menu` VALUES ('22', '21', 2, 0, '二级菜单1', NULL, '', 999, 'menu', 'menu1', b'0', b'0', b'0', NULL, 'admin', 'admin', '2019-01-04 16:23:29', '2020-06-21 17:27:20');
INSERT INTO `sys_menu` VALUES ('23', '21', 0, 1, '二级菜单2', NULL, 'nested/menu2/index', 999, 'menu', 'menu2', b'0', b'0', b'0', NULL, 'admin', NULL, '2019-01-04 16:23:57', NULL);
INSERT INTO `sys_menu` VALUES ('24', '22', 0, 1, '三级菜单1', 'Test', 'nested/menu1/menu1-1', 999, 'menu', 'menu1-1', b'0', b'0', b'0', NULL, 'admin', NULL, '2019-01-04 16:24:48', NULL);
INSERT INTO `sys_menu` VALUES ('27', '22', 0, 1, '三级菜单2', NULL, 'nested/menu1/menu1-2', 999, 'menu', 'menu1-2', b'0', b'0', b'0', NULL, 'admin', NULL, '2019-01-07 17:27:32', NULL);
INSERT INTO `sys_menu` VALUES ('28', '1', 3, 1, '任务调度', 'Timing', 'system/timing/index', 999, 'timing', 'timing', b'0', b'0', b'0', 'timing:list', 'admin', NULL, '2019-01-07 20:34:40', NULL);
INSERT INTO `sys_menu` VALUES ('3', '1', 3, 1, '角色管理', 'Role', 'system/role/index', 3, 'role', 'role', b'0', b'0', b'0', 'roles:list', 'admin', NULL, '2018-12-18 15:16:07', NULL);
INSERT INTO `sys_menu` VALUES ('30', '36', 0, 1, '代码生成', 'GeneratorIndex', 'generator/index', 32, 'dev', 'generator', b'0', b'1', b'0', NULL, 'admin', NULL, '2019-01-11 15:45:55', NULL);
INSERT INTO `sys_menu` VALUES ('32', '6', 0, 1, '异常日志', 'ErrorLog', 'monitor/log/errorLog', 12, 'error', 'errorLog', b'0', b'0', b'0', NULL, 'admin', NULL, '2019-01-13 13:49:03', NULL);
INSERT INTO `sys_menu` VALUES ('33', '10', 0, 1, 'Markdown', 'Markdown', 'components/MarkDown', 53, 'markdown', 'markdown', b'0', b'0', b'0', NULL, 'admin', NULL, '2019-03-08 13:46:44', NULL);
INSERT INTO `sys_menu` VALUES ('34', '10', 0, 1, 'Yaml编辑器', 'YamlEdit', 'components/YamlEdit', 54, 'dev', 'yaml', b'0', b'0', b'0', NULL, 'admin', NULL, '2019-03-08 15:49:40', NULL);
INSERT INTO `sys_menu` VALUES ('35', '1', 3, 1, '部门管理', 'Dept', 'system/dept/index', 6, 'dept', 'dept', b'0', b'0', b'0', 'dept:list', 'admin', NULL, '2019-03-25 09:46:00', NULL);
INSERT INTO `sys_menu` VALUES ('36', NULL, 7, 0, '系统工具', NULL, '', 30, 'sys-tools', 'sys-tools', b'0', b'0', b'0', NULL, 'admin', NULL, '2019-03-29 10:57:35', NULL);
INSERT INTO `sys_menu` VALUES ('37', '1', 3, 1, '岗位管理', 'Job', 'system/job/index', 7, 'Steve-Jobs', 'job', b'0', b'0', b'0', 'job:list', 'admin', NULL, '2019-03-29 13:51:18', NULL);
INSERT INTO `sys_menu` VALUES ('38', '36', 0, 1, '接口文档', 'Swagger', 'tools/swagger/index', 36, 'swagger', 'swagger2', b'0', b'0', b'0', NULL, 'admin', NULL, '2019-03-29 19:57:53', NULL);
INSERT INTO `sys_menu` VALUES ('39', '1', 3, 1, '字典管理', 'Dict', 'system/dict/index', 8, 'dictionary', 'dict', b'0', b'0', b'0', 'dict:list', 'admin', NULL, '2019-04-10 11:49:04', NULL);
INSERT INTO `sys_menu` VALUES ('41', '6', 0, 1, '在线用户', 'OnlineUser', 'monitor/online/index', 10, 'Steve-Jobs', 'online', b'0', b'0', b'0', NULL, 'admin', NULL, '2019-10-26 22:08:43', NULL);
INSERT INTO `sys_menu` VALUES ('44', '2', 0, 2, '用户新增', NULL, '', 2, '', '', b'0', b'0', b'0', 'user:add', 'admin', NULL, '2019-10-29 10:59:46', NULL);
INSERT INTO `sys_menu` VALUES ('45', '2', 0, 2, '用户编辑', NULL, '', 3, '', '', b'0', b'0', b'0', 'user:edit', 'admin', NULL, '2019-10-29 11:00:08', NULL);
INSERT INTO `sys_menu` VALUES ('46', '2', 0, 2, '用户删除', NULL, '', 4, '', '', b'0', b'0', b'0', 'user:del', 'admin', NULL, '2019-10-29 11:00:23', NULL);
INSERT INTO `sys_menu` VALUES ('48', '3', 0, 2, '角色创建', NULL, '', 2, '', '', b'0', b'0', b'0', 'roles:add', 'admin', NULL, '2019-10-29 12:45:34', NULL);
INSERT INTO `sys_menu` VALUES ('49', '3', 0, 2, '角色修改', NULL, '', 3, '', '', b'0', b'0', b'0', 'roles:edit', 'admin', NULL, '2019-10-29 12:46:16', NULL);
INSERT INTO `sys_menu` VALUES ('5', '1', 3, 1, '菜单管理', 'Menu', 'system/menu/index', 5, 'menu', 'menu', b'0', b'0', b'0', 'menu:list', 'admin', NULL, '2018-12-18 15:17:28', NULL);
INSERT INTO `sys_menu` VALUES ('50', '3', 0, 2, '角色删除', NULL, '', 4, '', '', b'0', b'0', b'0', 'roles:del', 'admin', NULL, '2019-10-29 12:46:51', NULL);
INSERT INTO `sys_menu` VALUES ('52', '5', 0, 2, '菜单新增', NULL, '', 2, '', '', b'0', b'0', b'0', 'menu:add', 'admin', NULL, '2019-10-29 12:55:07', NULL);
INSERT INTO `sys_menu` VALUES ('53', '5', 0, 2, '菜单编辑', NULL, '', 3, '', '', b'0', b'0', b'0', 'menu:edit', 'admin', NULL, '2019-10-29 12:55:40', NULL);
INSERT INTO `sys_menu` VALUES ('54', '5', 0, 2, '菜单删除', NULL, '', 4, '', '', b'0', b'0', b'0', 'menu:del', 'admin', NULL, '2019-10-29 12:56:00', NULL);
INSERT INTO `sys_menu` VALUES ('56', '35', 0, 2, '部门新增', NULL, '', 2, '', '', b'0', b'0', b'0', 'dept:add', 'admin', NULL, '2019-10-29 12:57:09', NULL);
INSERT INTO `sys_menu` VALUES ('57', '35', 0, 2, '部门编辑', NULL, '', 3, '', '', b'0', b'0', b'0', 'dept:edit', 'admin', NULL, '2019-10-29 12:57:27', NULL);
INSERT INTO `sys_menu` VALUES ('58', '35', 0, 2, '部门删除', NULL, '', 4, '', '', b'0', b'0', b'0', 'dept:del', 'admin', NULL, '2019-10-29 12:57:41', NULL);
INSERT INTO `sys_menu` VALUES ('6', NULL, 5, 0, '系统监控', NULL, NULL, 10, 'monitor', 'monitor', b'0', b'0', b'0', NULL, 'admin', NULL, '2018-12-18 15:17:48', NULL);
INSERT INTO `sys_menu` VALUES ('60', '37', 0, 2, '岗位新增', NULL, '', 2, '', '', b'0', b'0', b'0', 'job:add', 'admin', NULL, '2019-10-29 12:58:27', NULL);
INSERT INTO `sys_menu` VALUES ('61', '37', 0, 2, '岗位编辑', NULL, '', 3, '', '', b'0', b'0', b'0', 'job:edit', 'admin', NULL, '2019-10-29 12:58:45', NULL);
INSERT INTO `sys_menu` VALUES ('62', '37', 0, 2, '岗位删除', NULL, '', 4, '', '', b'0', b'0', b'0', 'job:del', 'admin', NULL, '2019-10-29 12:59:04', NULL);
INSERT INTO `sys_menu` VALUES ('64', '39', 0, 2, '字典新增', NULL, '', 2, '', '', b'0', b'0', b'0', 'dict:add', 'admin', NULL, '2019-10-29 13:00:17', NULL);
INSERT INTO `sys_menu` VALUES ('65', '39', 0, 2, '字典编辑', NULL, '', 3, '', '', b'0', b'0', b'0', 'dict:edit', 'admin', NULL, '2019-10-29 13:00:42', NULL);
INSERT INTO `sys_menu` VALUES ('66', '39', 0, 2, '字典删除', NULL, '', 4, '', '', b'0', b'0', b'0', 'dict:del', 'admin', NULL, '2019-10-29 13:00:59', NULL);
INSERT INTO `sys_menu` VALUES ('7', '6', 0, 1, '操作日志', 'Log', 'monitor/log/index', 11, 'log', 'logs', b'0', b'1', b'0', NULL, 'admin', 'admin', '2018-12-18 15:18:26', '2020-06-06 13:11:57');
INSERT INTO `sys_menu` VALUES ('73', '28', 0, 2, '任务新增', NULL, '', 2, '', '', b'0', b'0', b'0', 'timing:add', 'admin', NULL, '2019-10-29 13:07:28', NULL);
INSERT INTO `sys_menu` VALUES ('74', '28', 0, 2, '任务编辑', NULL, '', 3, '', '', b'0', b'0', b'0', 'timing:edit', 'admin', NULL, '2019-10-29 13:07:41', NULL);
INSERT INTO `sys_menu` VALUES ('75', '28', 0, 2, '任务删除', NULL, '', 4, '', '', b'0', b'0', b'0', 'timing:del', 'admin', NULL, '2019-10-29 13:07:54', NULL);
INSERT INTO `sys_menu` VALUES ('77', '18', 0, 2, '上传文件', NULL, '', 2, '', '', b'0', b'0', b'0', 'storage:add', 'admin', NULL, '2019-10-29 13:09:09', NULL);
INSERT INTO `sys_menu` VALUES ('78', '18', 0, 2, '文件编辑', NULL, '', 3, '', '', b'0', b'0', b'0', 'storage:edit', 'admin', NULL, '2019-10-29 13:09:22', NULL);
INSERT INTO `sys_menu` VALUES ('79', '18', 0, 2, '文件删除', NULL, '', 4, '', '', b'0', b'0', b'0', 'storage:del', 'admin', NULL, '2019-10-29 13:09:34', NULL);
INSERT INTO `sys_menu` VALUES ('80', '6', 0, 1, '服务监控', 'ServerMonitor', 'monitor/server/index', 14, 'codeConsole', 'server', b'0', b'0', b'0', 'monitor:list', 'admin', 'admin', '2019-11-07 13:06:39', '2020-05-04 18:20:50');
INSERT INTO `sys_menu` VALUES ('82', '36', 0, 1, '生成配置', 'GeneratorConfig', 'generator/config', 33, 'dev', 'generator/config/:tableName', b'0', b'1', b'1', '', 'admin', NULL, '2019-11-17 20:08:56', NULL);
INSERT INTO `sys_menu` VALUES ('83', '10', 0, 1, '图表库', 'Echarts', 'components/Echarts', 50, 'chart', 'echarts', b'0', b'1', b'0', '', 'admin', NULL, '2019-11-21 09:04:32', NULL);
INSERT INTO `sys_menu` VALUES ('9', '6', 0, 1, 'SQL监控', 'Sql', 'monitor/sql/index', 18, 'sqlMonitor', 'druid', b'0', b'0', b'0', NULL, 'admin', NULL, '2018-12-18 15:19:34', NULL);
INSERT INTO `sys_menu` VALUES ('90', NULL, 5, 1, '运维管理', 'Mnt', '', 20, 'mnt', 'mnt', b'0', b'0', b'0', NULL, 'admin', NULL, '2019-11-09 10:31:08', NULL);
INSERT INTO `sys_menu` VALUES ('92', '90', 3, 1, '服务器', 'ServerDeploy', 'mnt/server/index', 22, 'server', 'mnt/serverDeploy', b'0', b'0', b'0', 'serverDeploy:list', 'admin', NULL, '2019-11-10 10:29:25', NULL);
INSERT INTO `sys_menu` VALUES ('93', '90', 3, 1, '应用管理', 'App', 'mnt/app/index', 23, 'app', 'mnt/app', b'0', b'0', b'0', 'app:list', 'admin', NULL, '2019-11-10 11:05:16', NULL);
INSERT INTO `sys_menu` VALUES ('94', '90', 3, 1, '部署管理', 'Deploy', 'mnt/deploy/index', 24, 'deploy', 'mnt/deploy', b'0', b'0', b'0', 'deploy:list', 'admin', NULL, '2019-11-10 15:56:55', NULL);
INSERT INTO `sys_menu` VALUES ('97', '90', 1, 1, '部署备份', 'DeployHistory', 'mnt/deployHistory/index', 25, 'backup', 'mnt/deployHistory', b'0', b'0', b'0', 'deployHistory:list', 'admin', NULL, '2019-11-10 16:49:44', NULL);
INSERT INTO `sys_menu` VALUES ('98', '90', 3, 1, '数据库管理', 'Database', 'mnt/database/index', 26, 'database', 'mnt/database', b'0', b'0', b'0', 'database:list', 'admin', NULL, '2019-11-10 20:40:04', NULL);
...
-- ----------------------------
INSERT INTO `sys_quartz_job` VALUES ('2', 'testTask', '0/5 * * * * ?', b'1', '测试1', 'run1', 'test', '带参测试，多参使用json', '测试', NULL, NULL, NULL, 'admin', 'admin', '2019-08-22 14:08:29', '2020-05-24 13:58:33');
INSERT INTO `sys_quartz_job` VALUES ('3', 'testTask', '0/5 * * * * ?', b'1', '测试', 'run', '', '不带参测试', 'Zheng Jie', '', '5,6', b'1', 'admin', 'admin', '2019-09-26 16:44:39', '2020-05-24 14:48:12');
...
CREATE TABLE `sys_role`  (
  `role_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'ID',
...
CREATE TABLE `sys_user`  (
  `user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'ID',
  `dept_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '部门名称',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '2', 'admin', '管理员', '男', '18888888888', '201507802@qq.com', 'avatar-20200806032259161.png', '/Users/jie/Documents/work/me/admin/eladmin/~/avatar/avatar-20200806032259161.png', '$2a$10$Egp1/gvFlt7zhlXVfEFw4OfWQCGPw0ClmMcc6FjTnvXNRVf9zdMRa', b'1', b'1', 'admin', 'admin', '2020-05-03 16:38:31', '2018-08-23 09:11:56', '2020-09-05 10:43:31');
...
CREATE TABLE `tool_local_storage`  (
  `storage_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'ID',
...
CREATE TABLE `tool_qiniu_content`  (
  `content_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'ID',
  `bucket` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'Bucket 识别符',
