<template>
  <div>
    ...
    <div v-else>
      ...
      <!--表格渲染-->
      <el-table ref="table" v-loading="crud.loading" :border="true" :data="crud.data" highlight-current-row style="width: 100%;" @selection-change="crud.selectionChangeHandler">
